...
uint256 hashGenesisBlock("0x879a6f6dfd4006d5904885d55ac476abae5c75cd888e92ca0dcd7d01de00b03d");
...
const string strMessageMagic = "Branch Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Branch: 0.35 days
static const int64 nTargetSpacing = 120; // Branch: 2 minute for block
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal branch miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Branch", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
